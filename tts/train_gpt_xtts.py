...
# Logging parameters
RUN_NAME = "GPT_XTTS_v2.0_LibriSpeech_train-clean-100_FT"
PROJECT_NAME = "MLCL_Handover"
...
config_dataset = BaseDatasetConfig(
    formatter="custom",
    dataset_name="librispeech_train-clean-100",
    path="/home2/jw/workspace/asr/mlcl_handover/asr/dataset/LibriSpeech/LibriSpeech/train-clean-100/", # change this
    #meta_file_train="/home2/jw/workspace/asr/mlcl_handover/tts/train_samples.csv",
    language="en",
)
...
def main():
    ...
    train_samples, eval_samples = load_tts_samples(
        ...
        formatter=libri_formatter
    )
    
    print(len(train_samples), len(eval_samples)) #28283, 256
